...
hist.addEventListener("click", () => {
    ...
    if(hist.innerText == "HISTORY"){
        ...
        if(localStorage.length == 0){
            document.querySelector(".history").innerHTML = "<div class = 'empty'><img src='https://cdn-icons-png.flaticon.com/512/1380/1380641.png' alt='image'><span>No Search Found</span></div>";
        }
